...
trainImg = cv2.imread('test.jpeg')
trainImg2 = cv2.imread('test2.png')
...
img = cv2.imread(PATH_TO_OUTPUT+'image32/fragment27.jpg', flags=cv2.IMREAD_COLOR)
...
cv2.resizeWindow("Resized_Window", 998, 748)
